...
namespace VisualShape
{
    ...
    internal struct StreamSplitter : IJob
    {
        ...
        static StreamSplitter()
        {
            ...
            CommandSizes[(int)Command.Text] = UnsafeUtility.SizeOf<Command>() + UnsafeUtility.SizeOf<TextData>();
            CommandSizes[(int)Command.Text3D] = UnsafeUtility.SizeOf<Command>() + UnsafeUtility.SizeOf<TextData3D>();
